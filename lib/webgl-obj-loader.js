(function (scope, undefined) {
   ...
   *
   *     triangleShaderProgram.vertexNormalAttribute = gl.getAttribLocation(triangleShaderProgram, "aVertexNormal");
   *     gl.enableVertexAttribArray(triangleShaderProgram.vertexNormalAttribute);
   *
   *     triangleShaderProgram.textureCoordAttribute = gl.getAttribLocation(triangleShaderProgram, "aTextureCoord");
   *     gl.enableVertexAttribArray(triangleShaderProgram.textureCoordAttribute);
   *
   ...
   *     gl.vertexAttribPointer(triangleShaderProgram.vertexPositionAttribute, mesh.vertexBuffer.itemSize, gl.FLOAT, false, 0, 0);
   *     // it's possible that the mesh doesn't contain
   *     // any texture coordinates (e.g. suzanne.obj in the development branch).
   *     // in this case, the texture vertexAttribArray will need to be disabled
   *     // before the call to drawElements
   *     if(!mesh.textures.length){
   *       gl.disableVertexAttribArray(triangleShaderProgram.textureCoordAttribute);
   *     }
   *     else{
   ...
   *       gl.vertexAttribPointer(triangleShaderProgram.textureCoordAttribute, mesh.textureBuffer.itemSize, gl.FLOAT, false, 0, 0);
   *     }
   *
   *     gl.bindBuffer(gl.ARRAY_BUFFER, mesh.normalBuffer);
   *     gl.vertexAttribPointer(triangleShaderProgram.vertexNormalAttribute, mesh.normalBuffer.itemSize, gl.FLOAT, false, 0, 0);
   *
